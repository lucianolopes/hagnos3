...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  type: {
    ...
    url:          "Você deve informar uma url válida (ex.: http:www.site.com.br).",
    number:       "Este campo deve ser um número.",
    integer:      "Este campo deve ser um número inteiro.",
    digits:       "Este campo deve conter apenas dígitos.",
    alphanum:     "Este campo deve conter caracteres alfanuméricos."
  },
  notblank:       "Esta campo não deve ser em branco.",
  required:       "Campo obrigatório.",
  pattern:        "O valor informado parece ser inválido.",
  min:            "O valor informado deve ser maior do que ou igual a %s.",
  max:            "O valor informado deve ser menor do que ou igual a %s.",
  range:          "O valor informado deve ser entre %s e %s.",
  minlength:      "O valor informado é muito curto. Ele deve ter %s caracteres ou maise.",
  maxlength:      "O valor informado é muito longo. Ele deve ter %s caracteres ou menos.",
  length:         "O tamanho do valor informado é inválido. Ele deve ter entre %s e %s caracteres.",
